...
only the session-limit list — it now sweeps the whole table (`test-eval-requeue.sh`, 16/16; 4/8
...
(`test-company-preflight.sh` 45/45, `test-corpus-preflight.sh` 21/21) and the next full round
